...
use Omnipay\WxPay\Message\CloseOrderResponse;
use Omnipay\WxPay\Message\CompletePurchaseResponse;
use Omnipay\WxPay\Message\CreateOrderResponse;
use Omnipay\WxPay\Message\QueryOrderResponse;
use Omnipay\WxPay\Message\RefundOrderResponse;
...
class GatewayTest extends GatewayTestCase
{
    ...
    {
        parent::setUp();
        $this->gateway = Omnipay::create('WxPay');
